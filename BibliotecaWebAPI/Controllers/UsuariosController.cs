    ...
    public class UsuariosController : ApiController
    {
        ...
        public HttpResponseMessage ValidarLoginUsuario([FromBody] Dictionary<string, string> infoAcceso)
        {
            ...
            try
            {
                ...
                //Dictionary<string, string> infousuarios = BibliotecaBL.UsuariosBL.ObtenerCliente(infoAcceso);
        ...
        //[HttpPost]
        //[Route("api/UsuariosController/VerUsuarios")]
        //public HttpResponseMessage VerUsuarios([FromBody] Dictionary<string, string> infoAcceso)
        //{
        ...
        //        //Devolvemos el diccionario con toda la información adicional, serializada.
        //        response.Content = new StringContent(JsonConvert.SerializeObject(infousuarios), System.Text.Encoding.UTF8, "application/json");
        //        return response;
        //    }
        //    catch (Exception ex)
        //    {
